...
!(function (t, e) {
    ...
    function Ae(t, e, n) {
        var i,
            ...
            l = (s.resizer = (function (t) {
                ...
                return (
                    Me(n, "scroll", a.bind(n, "expand")), Me(i, "scroll", a.bind(i, "shrink")), e
                );
            })(
                ((i = function () {
                    if (s.resizer) {
    ...
    var bn = X.extend({
        ...
        update: function (t, e, n) {
            ...
            return (
                ...
                l.afterFit(),
                (l._ticksToDraw =
                    u.display && (u.autoSkip || "auto" === u.source) ? l._autoSkip(o) : o),
    ...
    var Rn = xn.extend({
                ...
                if (s.stacked || c) {
                    ...
                    for (t = 0; t < u.length; t++) {
                        ...
                        if (l.isDatasetVisible(t) && h(e))
                            for (
                                void 0 === f[g] && (f[g] = []), a = 0, r = (i = u[t].data).length;
                                a < r;
                                a++
                            ) {
                                var p = f[g];
            ...
            handleTickRangeOptions: function () {
                ...
                (t.min = On(e.min, t.min)),
                    ...
                    null === t.max &&
                        (t.max = 0 !== t.min ? Math.pow(10, Math.floor(Fn(t.min)) + 1) : 10),
                    null === t.minNotZero &&
                        (t.min > 0
                            ? (t.minNotZero = t.min)
                            : t.max < 1
    ...
    var Gn = Sn.extend({
            ...
            getIndexAngle: function (t) {
                var e = this.chart,
                    n =
                        (t * (360 / e.data.labels.length) + ((e.options || {}).startAngle || 0)) %
                        360;
    ...
    function oi(t, e) {
        ...
        return (
            ...
            null !== o
                ? +o
                : (a || "function" != typeof r || ((o = r(e)), V.isFinite(o) || (o = n.parse(o))),
                  o)
        );
    }
    function si(t, e) {
                    ...
                    (i._offsets = (function (t, e, n, i, a) {
                        ...
                        return (
                            a.offset &&
                                ...
                                ((r = ri(t, "time", e[0], "pos")),
                                (s =
                                    1 === e.length ? 1 - r : (ri(t, "time", e[1], "pos") - r) / 2),
        ...
        tn.helpers.each(
            ...
            function (t) {
                tn[t] = function (e, n) {
                    return new tn(
                        e,
                        tn.helpers.merge(n || {}, { type: t.charAt(0).toLowerCase() + t.slice(1) })
                    );
                };
            }
        ),
