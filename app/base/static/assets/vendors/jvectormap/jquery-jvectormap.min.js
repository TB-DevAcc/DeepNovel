    ...
    (function (factory) {
        ...
        var special = ($.event.special.mousewheel = {
            ...
            getLineHeight: function (elem) {
                return parseInt(
                    $(elem)["offsetParent" in $.fn ? "offsetParent" : "parent"]().css("fontSize"),
                    10
                );
            },
...
(jvm.$ = jQuery),
    ...
    (jvm.AbstractCanvasElement.prototype.addGroup = function (parentGroup) {
        ...
        return (
            parentGroup ? parentGroup.node.appendChild(el.node) : this.node.appendChild(el.node),
            (el.canvas = this),
            el
        );
    }),
    ...
    (jvm.VMLCanvasElement.prototype.setSize = function (width, height) {
        ...
        if (
            ...
            for (
                groups = this.node.getElementsByTagName("group"), i = 0, l = groups.length;
                l > i;
                i++
            )
    ...
    (jvm.NumericScale.prototype = {
        ...
        getValue: function (value) {
            var l,
                ...
                i = 0;
            for (
                "function" == typeof this.normalize && (value = this.normalize(value)), i = 0;
    ...
    (jvm.Proj = {
        ...
        mill_inv: function (x, y, c) {
            return {
                lat:
                    (2.5 * Math.atan(Math.exp((0.8 * y) / this.radius)) - (5 * Math.PI) / 8) *
                    this.degRad,
        ...
        lcc: function (lat, lng, c) {
            var fi0 = 0,
                ...
                n =
                    ...
                    Math.log(
                        Math.tan(Math.PI / 4 + fi2 / 2) * (1 / Math.tan(Math.PI / 4 + fi1 / 2))
                    ),
    ...
    (jvm.MapObject.prototype.setHovered = function (isHovered) {
        this.isHovered !== isHovered &&
            ...
            this.label && ((this.label.isHovered = isHovered), this.label.updateStyle()));
    }),
                ...
                this.container.delegate(
                    ...
                    function (e) {
                        var baseVal =
                            ...
                            type =
                                -1 === baseVal.indexOf("jvectormap-region") ? "marker" : "region",
            ...
            return (
                ...
                "undefined" != typeof anchorX &&
                    ...
                    isCentered
                        ? ((transX =
                              anchorX +
                              (this.defaultWidth * (this.width / (this.defaultWidth * scale))) /
                                  2),
                          (transY =
                              anchorY +
        ...
        setFocus: function (config) {
            ...
            return (
                config.lat && config.lng
                    ...
                    : config.x &&
                      config.y &&
                      ((config.x *= -this.defaultWidth), (config.y *= -this.defaultHeight)),
                this.setScale(
        ...
        repositionMarkers: function () {
            ...
            for (i in this.markers)
                (point = this.getMarkerPosition(this.markers[i].config)),
                    point !== !1 && this.markers[i].element.setStyle({ cx: point.x, cy: point.y });
        },
        ...
        pointToLatLng: function (x, y) {
            ...
            for (i = 0; i < insets.length; i++)
                if (
                    ...
                    (ny =
                        (ny / (inset.height * this.scale)) * (bbox[1].y - bbox[0].y) + bbox[0].y),
