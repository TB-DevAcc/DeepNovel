    ...
    "function" == typeof define && define.amd
        ...
        ? (module.exports = function (e, t) {
              return (
                  void 0 === t &&
                      (t =
                          "undefined" != typeof window ? require("jquery") : require("jquery")(e)),
                  n(t),
                  t
              );
          })
    ...
    var e = (function () {
            ...
            function c(e) {
                var t,
                    n = e ? e.indexOf("!") : -1;
                return (
                    -1 < n && ((t = e.substring(0, n)), (e = e.substring(n + 1, e.length))), [t, e]
                );
            }
            function S(e) {
                return e ? c(e) : [];
            ...
            return (
                ...
                e.define("select2/selection/base", ["jquery", "../utils", "../keys"], function (
                    n,
                    r,
                    i
                ) {
                ...
                e.define("select2/selection/multiple", ["jquery", "./base", "../utils"], function (
                    i,
                    e,
                    l
                ) {
                ...
                e.define("select2/selection/search", ["jquery", "../utils", "../keys"], function (
                    r,
                    a,
                    l
                ) {
                ...
                e.define("select2/data/select", ["./base", "../utils", "jquery"], function (
                    e,
                    a,
                    l
                ) {
                ...
                e.define("select2/data/array", ["./select", "../utils", "jquery"], function (
                    e,
                    f,
                    g
                ) {
                ...
                e.define("select2/core", ["jquery", "./options", "./utils", "./keys"], function (
                    o,
                    c,
                    u,
                    r
